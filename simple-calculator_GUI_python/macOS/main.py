...
res = sp.run(f"{CALCPATH} -h",stdout=sp.PIPE,universal_newlines=True,shell=True)
#res = sp.run(f"{CALCPATH} -h",stdout=sp.PIPE,universal_newlines=True)
